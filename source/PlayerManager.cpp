...
void PlayerManager::SetUpPlayers(PlayerColorData& color, int player_count)
{
    ...
    std::cout << "[PlMan]Setting up players\n";
    ...
    {
        std::cout << "[PlMan]Making Player " << std::to_string(i+1) << ". \n";
        std::cout << "mKeybinds " << i << " length " << mKeybinds[i].size() << "\n";
